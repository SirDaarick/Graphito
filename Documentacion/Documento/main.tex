...
% --- PORTADAS ---
\pagestyle{empty}
% \include{portada1} % Descomenta cuando verifiques los nombres de archivo
% \include{portada2}
...
\include{capitulos/generalidades}
\include{capitulos/estado_del_arte}
\include{capitulos/marco_teorico_v3}
\include{capitulos/propuesta_de_solucion}
\include{capitulos/requerimientos}
