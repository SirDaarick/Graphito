...
\begin{minipage}[c][\textheight][c]{3cm}
    \centering
    \includegraphics[height=3.5cm]{logo-ipn.png}
    ...
    \includegraphics[height=2.5cm]{logo-escom.png}
...
semántica para cursos introductorios de programación''
    ...
    \textbf{Maribel Aragón García}

    \vfill
    {\fontsize{12}{14}\selectfont\textit{Fecha de presentación\\ de TT-I}}

    \begin{flushright}
        {\fontsize{12}{14}\selectfont Mayo 2026}
    \end{flushright}
\end{minipage}
