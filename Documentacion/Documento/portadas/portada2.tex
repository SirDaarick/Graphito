...
\begin{minipage}[c]{0.15\textwidth}
    ...
    \includegraphics[width=2.2cm]{logo-ipn.png} 
\end{minipage}%
\hfill
...
\begin{minipage}[c]{0.15\textwidth}
    \centering
    \includegraphics[width=2.8cm]{logo-escom.png}
\end{minipage}
...
\begin{minipage}[t]{0.45\textwidth}
    \raggedleft
    -{Fecha de presentación de TT-I: 13 de Mayo del 2026}\\
\end{minipage}
...
\begin{minipage}[t]{0.48\textwidth}
    \centering
    {\fontsize{14}{16}\selectfont \textbf{Maribel Aragón García}}
\end{minipage}
