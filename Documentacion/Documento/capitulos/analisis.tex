...
\begin{itemize}
	...
	\item \textbf{Ejecución de Comparaciones (UC7, UC12):} Constituye el núcleo operativo del sistema. Al agregar una entrega para comparar (UC7), el sistema ejecuta automáticamente (\textit{include}) el análisis de doble canal (UC12), el cual integra el procesamiento semántico de flujo de datos y la detección estilométrica de patrones generativos.
...
\begin{table}[ht]
	...
	\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.8cm} >{\raggedright\arraybackslash}p{2.8cm} c >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}X}
		\toprule
