...
El analisis de la literatura, determina que el analisis textual enfocado en código fuente tiene las siguientes fortalezas y limitaciones \cite{Roy2007Survey, karakatic2022software}:
...
\subsection{Modelos para el analisis estilometrico}
